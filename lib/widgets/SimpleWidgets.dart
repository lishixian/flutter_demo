...
class SimpleWidgets extends StatefulWidget {
  //SimpleWidgets({Key key}) : super(key: key);
  final String title = "title";
  final int index = 5;

  const SimpleWidgets({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return SimpleWidgetState();
  }
}
                      ...
                      : index == 5
                          ? new Container(
                              ...
                              child: new Widght_3D(
                                  ...
                                  asset:true), //assets/file.obj为我们的本地obj文件，需要到pubspec.yaml中进行配置
                            )
                          : new Text('haha'),
        ),
      ),
